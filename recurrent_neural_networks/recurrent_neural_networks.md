...
For example, we begin with a zero'ed vector as our hidden state on the left. We feed it into the
...
**This means EACH character has some chance to be selected** Samplng technique gives us more
